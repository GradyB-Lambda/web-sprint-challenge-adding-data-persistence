...
1. Explain the difference between Relational Databases and SQL.
   RD is a data model where data is kept in table like structures, linked through primary keys, and secondary foreign keys, to link across data tables. SQL is the syntax use to build data, and query data as well.
2. Why do tables need a Primary Key?
   Primary keys represent the an entity comprised of many properties. The primary keys serve as unique identifiers.
3. What is the name given to a table column that references the Primary Key on another table?

4. What do we need in order to have a _many to many_ relationship between two tables?
   an "appointment" table / intermediary table
